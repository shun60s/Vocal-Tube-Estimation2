...
class compute_tube_peak(object):
    def __init__(self, rg0=0.95, rl0=0.9 ,NUM_TUBE=3, disp=False):
        self.rg0=rg0
        self.rl0=0.9
    ...
    def __call__(self, X, xw_input=None):
        ...
        if (len(X) == 8) or (len(X) == 7) : # X=[L1,L2,L3,L4,A1,A2,A3,A4] or X=[L1,L2,L3,L4,r1,r2,r3]   when four tube model
